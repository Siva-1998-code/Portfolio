...
function Headphone() {
  return (
    <Container >
      <h1 className='mt-4 mb-4'>Featured Electronics</h1>
      <Row className='text-center'>
        ...
        <Col>
          <Card style={{ width: '18rem' }} className='mt-3 mb-3 py-3'>
            <Link>
              <Card.Img variant="top" src="https://m.media-amazon.com/images/I/61e9td4-rjL._SL1500_.jpg" />
              <Card.Body>
                <Card.Title>Realme buds Wireless</Card.Title>
              </Card.Body>
            </Link>
          </Card>
        </Col>
